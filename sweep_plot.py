...
def plot_fig(technode=""):
    ...
    for a in arch_list:
        ...
        if print_energy_eff:
            ...
            print("unary 256c (baseline)     :", onchip_energy_eff_list_ug_spm)
            ...
            print("ugemm 256c (baseline)     :", total_energy_eff_list_ug_spm)
        ...
        if print_power_onchip:
            ...
            for i in range(len(onchip_power_list_ug_spm)):
                onchip_power_ug_r_list_u6_wspm.append(1 - onchip_power_list_u6_wspm[i] / onchip_power_list_ug_spm[i])
                onchip_power_ug_r_list_u7_wspm.append(1 - onchip_power_list_u7_wspm[i] / onchip_power_list_ug_spm[i])
                onchip_power_ug_r_list_u8_wspm.append(1 - onchip_power_list_u8_wspm[i] / onchip_power_list_ug_spm[i])
            print("ugemm 256c    (baseline)  :", onchip_power_list_ug_spm)
        ...
        if print_power_total:
            ...
            for i in range(len(total_power_list_ug_spm)):
                total_power_ug_r_list_u6_wspm.append(1 - total_power_list_u6_wspm[i] / total_power_list_ug_spm[i])
                total_power_ug_r_list_u7_wspm.append(1 - total_power_list_u7_wspm[i] / total_power_list_ug_spm[i])
                total_power_ug_r_list_u8_wspm.append(1 - total_power_list_u8_wspm[i] / total_power_list_ug_spm[i])
            print("ugemm 256c (baseline)    :", total_power_list_ug_spm)
        ...
        if print_power_eff:
            ...
            print("ugemm 256c (baseline)     :", onchip_power_eff_list_ug_spm)
            ...
            print("ugemm 256c (baseline)     :", total_power_eff_list_ug_spm)
